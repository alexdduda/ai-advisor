    ...
    "blocks": [
      {
        ...
        "courses_needed": None,
        "group_name": None,
        "notes": "Shared foundation required in all BMus programs: music theory, musicianship, keyboard proficiency, music history, practical lessons, and professional development.",
        "sort_order": 1,
        "courses": BMUS_CORE,
      },
      {
      ...
      },
      {
        ...
        "courses_needed": None,
        "group_name": None,
        "notes": "All diction courses are required for voice performance majors.",
        "sort_order": 3,
        "courses": [
          {"subject": "MUVL", "catalog": "280", "title": "Italian Diction",  "credits": 2, "is_required": True,  "recommended": True,  "recommendation_reason": "Essential for operatic repertoire; IPA-based Italian lyric diction"},
          {"subject": "MUVL", "catalog": "281", "title": "German Diction",   "credits": 2, "is_required": True,  "recommended": True,  "recommendation_reason": "German Lied and opera diction"},
          {"subject": "MUVL", "catalog": "380", "title": "French Diction",   "credits": 2, "is_required": True,  "recommended": True,  "recommendation_reason": "French mélodie and opera diction"},
          {"subject": "MUSP", "catalog": "350", "title": "Musicianship for Voice", "credits": 2, "is_required": False, "recommended": True, "recommendation_reason": "Sight-reading and ear-training adapted for singers"},
        ],
      },
      {
        ...
        "courses_needed": None,
        "group_name": None,
        "notes": "8 credits of ensembles (MUEN prefix) required. Singers are assigned to choral ensembles and opera scenes each semester.",
        "sort_order": 4,
        "courses": [
          {"subject": "MUEN", "catalog": "593", "title": "Choral Ensembles",         "credits": 2, "is_required": False, "recommended": True, "choose_from_group": "ensembles", "recommendation_reason": "Primary large ensemble for voice students; 1 credit per semester × 8 semesters"},
          {"subject": "MUEN", "catalog": "597", "title": "McGill Symphony Orchestra", "credits": 2, "is_required": False, "recommended": False, "choose_from_group": "ensembles", "recommendation_reason": "Open to orchestral instrumentalists; voice majors typically assigned to choral ensembles"},
          {"subject": "MUEN", "catalog": "595", "title": "Jazz Ensembles",            "credits": 1, "is_required": False, "recommended": False, "choose_from_group": "ensembles", "recommendation_reason": "Available with audition and instructor permission"},
        ],
      },
      {
        ...
        "courses_needed": None,
        "group_name": None,
        "notes": "6 credits from courses with MUHL or MUPP prefix at 300-level or above.",
        "sort_order": 5,
        "courses": [
          ...
          {"subject": "MUHL", "catalog": "382", "title": "Baroque Music",             "credits": 3, "is_required": False, "recommended": True, "choose_from_group": "music_history_300", "choose_n_credits": 6, "recommendation_reason": "Especially relevant for standard vocal repertoire"},
          {"subject": "MUHL", "catalog": "383", "title": "Classical Music",           "credits": 3, "is_required": False, "recommended": True, "choose_from_group": "music_history_300", "choose_n_credits": 6, "recommendation_reason": "Core classical opera and Lied repertoire"},
          {"subject": "MUHL", "catalog": "377", "title": "Baroque Opera",             "credits": 3, "is_required": False, "recommended": True, "choose_from_group": "music_history_300", "choose_n_credits": 6, "recommendation_reason": "Directly relevant for opera singers"},
          {"subject": "MUPP", "catalog": "381", "title": "Topics in Performance Practice", "credits": 3, "is_required": False, "recommended": True, "choose_from_group": "music_history_300", "choose_n_credits": 6, "recommendation_reason": "Historical performance practice context"},
        ],
      },
    ],
  },
    ...
    "blocks": [
      {
        ...
        "courses": [
          ...
          {"subject": "MUJZ", "catalog": "186",  "title": "Jazz History Survey",         "credits": 3, "is_required": True, "recommended": True, "recommendation_reason": "Overview of jazz from its origins to the present"},
          {"subject": "MUJZ", "catalog": "223",  "title": "Jazz Ear Training 1",         "credits": 2, "is_required": True, "recommended": True, "recommendation_reason": "Jazz-specific ear training and improvisation foundations; Year 2"},
          {"subject": "MUJZ", "catalog": "224",  "title": "Jazz Ear Training 2",         "credits": 2, "is_required": True, "recommended": True, "recommendation_reason": "Continuation; Year 2"},
          {"subject": "MUJZ", "catalog": "260",  "title": "Jazz Arranging 1",            "credits": 2, "is_required": True, "recommended": True, "recommendation_reason": "Introduction to jazz arranging; Year 2"},
          {"subject": "MUJZ", "catalog": "261",  "title": "Jazz Arranging 2",            "credits": 2, "is_required": True, "recommended": True, "recommendation_reason": "Continuation; Year 2"},
          {"subject": "MUJZ", "catalog": "340",  "title": "Applied Jazz Theory",         "credits": 3, "is_required": True, "recommended": True, "recommendation_reason": "Advanced jazz harmony and analysis; Year 3"},
          {"subject": "MUJZ", "catalog": "423",  "title": "Jazz Ear Training 3",         "credits": 2, "is_required": True, "recommended": True, "recommendation_reason": "Advanced improvisation and musicianship; Year 3"},
          {"subject": "MUJZ", "catalog": "424",  "title": "Jazz Ear Training 4",         "credits": 2, "is_required": True, "recommended": True, "recommendation_reason": "Continuation; Year 3"},
        ],
      },
      {
  ...
  # ══════════════════════════════════════════════════════════════════════════
  {
    ...
    "blocks": [
      ...
      },
      {
        ...
        "title": "Upper-Level Theory Courses",
        "block_type": "required",
        "credits_needed": None, "courses_needed": None, "group_name": None,
        "notes": "Advanced theory courses required for the major; minimum grade of B- in all MUTH-prefix courses.",
        "sort_order": 2,
        "courses": [
          {"subject": "MUTH", "catalog": "430", "title": "Schenkerian Theory and Analysis",  "credits": 3, "is_required": True, "recommended": True, "recommendation_reason": "Foundational Schenkerian analysis methods; Year 3–4"},
          {"subject": "MUTH", "catalog": "432", "title": "Topics in Post-Tonal Analysis",    "credits": 3, "is_required": True, "recommended": True, "recommendation_reason": "Set theory, twelve-tone analysis; Year 3–4"},
          {"subject": "MUTH", "catalog": "434", "title": "Methods in Tonal Theory",          "credits": 3, "is_required": True, "recommended": True, "recommendation_reason": "Advanced analytical methodologies; Year 3–4"},
          {"subject": "MUTH", "catalog": "540", "title": "Topics in Music Theory",           "credits": 3, "is_required": False,"recommended": True, "recommendation_reason": "Seminar on special topics; Year 4"},
          {"subject": "MUSP", "catalog": "346", "title": "Post-Tonal Musicianship",          "credits": 2, "is_required": False,"recommended": True, "recommendation_reason": "Ear-training in post-tonal idioms; complements theory coursework"},
        ],
      },
      {
