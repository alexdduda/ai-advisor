...
DENTISTRY_PROGRAMS = [
  {
    ...
    "total_credits": 221,
    "description": "The D.M.D. program is an innovative four-year professional degree focused on evidence-based oral health practice, social justice, and leadership. Years 1–2 include the Fundamentals of Medicine and Dentistry (FMD) taught jointly with the Faculty of Medicine and Health Sciences (INDS courses), plus DENT-specific pre-clinical simulation labs. Year 2 transitions to advanced pre-clinical skills. Years 3–4 are predominantly clinical practice in the state-of-the-art undergraduate teaching clinic, with hospital rotations at the Montreal General, Montreal Children's, and community clinics. Graduates are eligible for licensure by the Ordre des dentistes du Québec and by other provincial bodies across Canada. Admission requires a completed 120-credit bachelor's degree (any discipline), science prerequisites, and CASPer test. French B2 proficiency is required by the start of Year 3 clinical courses.",
    "ecalendar_url": 'https://www.mcgill.ca/study/2024-2025/faculties/dentistry/undergraduate/programs/doctor-dental-medicine-dmd-dentistry-four-year-program',
    "blocks": [
      {
        "block_key": 'dmd_year1_fmd',
        "title": 'Year 1 – Fundamentals of Medicine and Dentistry (FMD)',
        "block_type": 'required',
        "notes": 'All Year 1 courses are required. INDS courses (111–119) are taught jointly with MD,CM students and cover organ systems from the molecular to the global level. DENT 111J1/J2/J3 runs across Fall, Winter, and Summer terms as a J-series (must all be completed in consecutive terms). IPEA 500 and 501 are non-credit interprofessional workshops. DENT 113D1/D2 (Community Oral Health Services) may not be offered every year – confirm scheduling on Minerva.',
        "sort_order": 0,
        "courses": [
          {
            "subject": 'INDS',
          ...
          },
          {
            "subject": 'DENT',
            "catalog": '112',
            "title": 'Oral Medicine and Manifestation of Systemic Diseases',
            "credits": 4.0,
            "is_required": True,
            "recommended": True,
          ...
          },
          {
            "subject": 'DENT',
            "catalog": '113D1',
            "title": 'Community Oral Health Services 1',
            "credits": 0.5,
            "is_required": True,
            "recommended": True,
          ...
          },
          {
            "subject": 'DENT',
            "catalog": '114D1',
            "title": 'Head and Neck Anatomy and Histology',
            "credits": 3.0,
            "is_required": True,
            "recommended": True,
          ...
          },
          {
            "subject": 'DENT',
            "catalog": '210',
            "title": 'Introduction to Oral Medicine and Oral Diagnosis',
            "credits": 1.0,
            "is_required": True,
            "recommended": True,
      ...
      },
      {
        ...
        "block_type": 'required',
        "notes": 'INDS 211 and 212 complete the FMD shared curriculum. Both require successful completion of all Promotion Period I courses (Year 1 block) before enrolment.',
        "sort_order": 1,
        "courses": [
          {
            "subject": 'INDS',
            "catalog": '211',
            "title": 'Reproduction and Sexuality',
            "credits": 6.0,
            "is_required": True,
            "recommended": True,
      ...
      },
      {
        ...
        "block_type": 'required',
        "notes": 'Year 2 builds dental science knowledge and begins simulation lab training. DENT 231/232 may not be offered in 2024-2025 for incoming students – check Minerva. DENT 242J1/J2/J3 (Restorative Dentistry Operative) is the primary psychomotor-skills lab, covering tooth preparation and direct restorations. DENT 243 (Endodontics A) covers root canal fundamentals with simulation lab.',
        "sort_order": 2,
        "courses": [
          {
            "subject": 'DENT',
            "catalog": '213D1',
            "title": 'Community Oral Health Services 2',
            "credits": 0.5,
            "is_required": True,
            "recommended": True,
          ...
          },
          {
            "subject": 'DENT',
            "catalog": '242J1',
            "title": 'Restorative Dentistry (Operative)',
            "credits": 2.0,
            "is_required": True,
            "recommended": True,
      ...
      },
      {
        ...
        "block_type": 'required',
        "notes": "Years 3 and 4 consist predominantly of clinical practice courses in the undergraduate teaching clinic and hospital rotations. The curriculum is under constant revision (per eCalendar disclaimer). Key discipline areas covered include: Orthodontics (tooth movement / management of malocclusion), Prosthodontics (fixed and removable prosthetics, edentulous restorations), Endodontics B (advanced root canal), Periodontics, Oral Surgery, Paediatric Dentistry (rotation at Montreal Children's Hospital), Oral Medicine and Oral Pathology, Oral and Maxillofacial Radiology, Dental Public Health B, and Comprehensive Patient Care clinic. French B2 proficiency is required by the start of Year 3. Course codes seen in recent eCalendars include DENT 215 (Orthodontics), DENT 221 (Tooth Loss), DENT 244 (Paediatric Dentistry A), and various DENT 3xx–4xx clinical rotations. Consult your program adviser and Minerva for the complete up-to-date course list.",
        "sort_order": 3,
        "courses": [
          {
            "subject": 'DENT',
            "catalog": '215D1',
            "title": 'Tooth Movement (Orthodontics)',
            "credits": 1.8,
            "is_required": True,
            "recommended": True,
  ...
  },
  {
    ...
    "faculty": 'Faculty of Dental Medicine and Oral Health Sciences',
    "total_credits": 30,
    "description": 'The Dent-P Year is a one-year preparatory program for direct CEGEP graduates (Quebec residents only) who wish to enter the four-year D.M.D. program. Students are registered in the Faculty of Science during the preparatory year and must complete 30 credits: 18 credits of required sciences + 12 credits of humanities/electives. Students must maintain a CGPA of ≥ 3.5 with all individual grades ≥ B in required courses and passing grades in complementary courses to be promoted into D.M.D. Year 1. Application deadline is March 1 (vs November 1 for the direct 4-year D.M.D.). Dent-P is open only to current final-year CEGEP Sciences Profile students who are Quebec residents. University-level students and students outside Quebec are NOT eligible for this program. CASPer test is required. Students who do not meet promotion criteria may transfer into a B.Sc. and reapply to the D.M.D. after completing their undergraduate degree.',
    "ecalendar_url": 'https://www.mcgill.ca/study/2024-2025/faculties/dentistry/undergraduate/programs/bachelor-science-bsc-dental-preparatory-dent-p',
    "blocks": [
      {
        ...
        "block_type": 'required',
        "credits_needed": 18,
        "notes": '18 credits of university-level science courses required. The specific course list is determined at admission and is designed to bridge CEGEP-level preparation to university-level expectations. Typical required courses cover biology (cell and molecular), chemistry, organic chemistry, physics, and mathematics. All required courses must be passed with a grade of B or higher. These credits count toward a B.Sc. if the student does not proceed to DMD.',
        "sort_order": 0,
        "courses": [
          {
            "subject": 'BIOL',
      ...
      },
      {
        ...
        "credits_needed": 12,
        "notes": '12 credits of humanities, social sciences, or elective courses are required to round out the 30-credit Dent-P year. Passing grades are required (B not mandatory). Courses are selected to broaden education in preparation for a patient-facing professional career. The Faculty of Dentistry encourages courses that develop interpersonal skills, active listening, empathy, and cultural competence. Examples include psychology, sociology, ethics, communication, or language courses. Confirm specific approved electives with the Dent-P program coordinator.',
        "sort_order": 1,
        "courses": [
          {
            "subject": 'PSYC',
