...
MANAGEMENT_PROGRAMS = [
...

  {
    ...
    "blocks": [
      ...
      },
      {
        ...
        "credits_needed": 6,
        "courses_needed": None,
        "group_name": "6 credits from Accounting Complementary Courses",
        "notes": "Select 2 courses (6 credits) from the following list to complete the concentration.",
        "sort_order": 2,
        "courses": [
          {"subject": "ACCT", "catalog": "354", "title": "Financial Statement Analysis",     "credits": 3, "is_required": False},
    ...
    "blocks": [
      ...
      },
      {
        ...
        "courses": [
          ...
          {"subject": "FINE", "catalog": "451", "title": "Securities Regulation",         "credits": 3, "is_required": False},
          {"subject": "FINE", "catalog": "460", "title": "Financial Engineering",         "credits": 3, "is_required": False},
    ...
    "blocks": [
      {
        ...
        "courses_needed": None,
        "group_name": None,
        "notes": "All 7 courses are required for the Honours program. Minimum grade of B- in each.",
        "sort_order": 1,
        "courses": [
          {"subject": "FINE", "catalog": "342", "title": "Corporate Finance",                     "credits": 3, "is_required": True},
          {"subject": "FINE", "catalog": "441", "title": "Investment Management",                 "credits": 3, "is_required": True},
          ...
          {"subject": "FINE", "catalog": "448", "title": "Financial Derivatives",                 "credits": 3, "is_required": True},
          {"subject": "FINE", "catalog": "482", "title": "International Finance 1",               "credits": 3, "is_required": True},
          {"subject": "FINE", "catalog": "488", "title": "Advanced Investment Analysis",          "credits": 3, "is_required": True},
          {"subject": "MGSC", "catalog": "372", "title": "Advanced Business Statistics",          "credits": 3, "is_required": True},
        ],
      },
      {
        "block_key": "him_complementary",
        "title": "Complementary Courses",
        "block_type": "group",
        "credits_needed": 24,
        "courses_needed": None,
        "group_name": "Complementary Finance and Accounting Courses",
        "notes": (
          "24 credits from undergraduate FINE courses and up to some ACCT courses. "
          "FINE 434 Topics in Finance 1 and FINE 435 Advanced Topics in Finance 1 "
          "may count with Academic Director approval."
        ),
        "sort_order": 2,
        "courses": [
          {"subject": "ACCT", "catalog": "351", "title": "Intermediate Financial Accounting 1",  "credits": 3, "is_required": False},
          ...
          {"subject": "ACCT", "catalog": "385", "title": "Principles of Taxation",               "credits": 3, "is_required": False},
          {"subject": "ACCT", "catalog": "452", "title": "Financial Reporting Valuation",        "credits": 3, "is_required": False},
          {"subject": "FINE", "catalog": "434", "title": "Topics in Finance 1",                  "credits": 3, "is_required": False},
          {"subject": "FINE", "catalog": "435", "title": "Advanced Topics in Finance 1",         "credits": 3, "is_required": False},
          {"subject": "FINE", "catalog": "451", "title": "Securities Regulation",                "credits": 3, "is_required": False},
          {"subject": "FINE", "catalog": "460", "title": "Financial Engineering",                "credits": 3, "is_required": False},
          {"subject": "FINE", "catalog": "462", "title": "Real Estate Finance",                  "credits": 3, "is_required": False},
          {"subject": "FINE", "catalog": "472", "title": "Fixed Income Securities",              "credits": 3, "is_required": False},
    ...
    "blocks": [
      ...
      },
      {
        ...
        "courses": [
          ...
          {"subject": "MRKT", "catalog": "456", "title": "Business to Business Marketing",      "credits": 3, "is_required": False},
    ...
    "blocks": [
      {
        ...
        "courses_needed": None,
        "group_name": None,
        "notes": "All 5 courses are required for the major.",
        "sort_order": 1,
        "courses": [
          {"subject": "INSY", "catalog": "336", "title": "Data Preparation and Analysis for Business Analytics", "credits": 3, "is_required": True},
          {"subject": "INSY", "catalog": "442", "title": "Data Analysis and Visualization",                      "credits": 3, "is_required": True},
          {"subject": "INSY", "catalog": "446", "title": "Data Mining for Business Analytics",                   "credits": 3, "is_required": True},
          {"subject": "MGSC", "catalog": "372", "title": "Advanced Business Statistics",                         "credits": 3, "is_required": True},
          {"subject": "MGSC", "catalog": "401", "title": "Management Science",                                   "credits": 3, "is_required": True},
        ],
      },
      {
        ...
        "notes": "Choose from INSY and MGSC advanced analytics courses.",
        "sort_order": 2,
        "courses": [
          {"subject": "INSY", "catalog": "416", "title": "Data-Driven Models for Operations Analytics", "credits": 3, "is_required": False},
      ...
      },
      {
        ...
        "courses_needed": None,
        "group_name": None,
        "notes": "3 credits of experiential learning required (meets BCom EL requirement).",
        "sort_order": 3,
        "courses": [
          {"subject": "MGSC", "catalog": "483", "title": "Analytics-Based Community Project", "credits": 3, "is_required": True},
        ],
      },
    ],
  },
    ...
    "blocks": [
      {
        ...
        "courses_needed": None,
        "group_name": None,
        "notes": "All 3 courses are required.",
        "sort_order": 1,
        "courses": [
          {"subject": "INSY", "catalog": "336", "title": "Data Preparation and Analysis for Business Analytics", "credits": 3, "is_required": True},
          {"subject": "INSY", "catalog": "442", "title": "Data Analysis and Visualization",                      "credits": 3, "is_required": True},
      ...
      {
        "block_key": "bana_conc_complementary",
        "title": "Complementary Business Analytics Courses",
        "block_type": "group",
        "credits_needed": 6,
        "courses_needed": None,
        "group_name": "6 credits from Complementary Analytics Courses",
        "notes": "Select 2 courses (6 credits) from the following list.",
        "sort_order": 2,
        "courses": [
  ...
  # ══════════════════════════════════════════════════════════════════
  {
    ...
    "blocks": [
      {
        "block_key": "stra_major_required",
        "title": "Required Strategic Management Courses",
        "block_type": "required",
        "credits_needed": 9,
        "courses_needed": None,
        "group_name": None,
        ...
        "sort_order": 1,
        "courses": [
          {"subject": "MGPO", "catalog": "340", "title": "Competitive Strategy",              "credits": 3, "is_required": True},
          {"subject": "MGPO", "catalog": "431", "title": "Managing Globalization",             "credits": 3, "is_required": True},
          {"subject": "MGPO", "catalog": "449", "title": "Managing Organizational Change",    "credits": 3, "is_required": True},
        ],
      },
      {
        "block_key": "stra_major_complementary_mgpo",
        "title": "Complementary Strategy Courses (MGPO)",
        "block_type": "group",
        "credits_needed": 12,
        "courses_needed": None,
        "group_name": "Complementary Management Policy Courses",
        "notes": "Select from MGPO and approved courses to complete 30 credits total.",
        "sort_order": 2,
        "courses": [
          {"subject": "MGPO", "catalog": "341", "title": "Strategies for Developing Countries",      "credits": 3, "is_required": False},
          {"subject": "MGPO", "catalog": "349", "title": "Strategic Innovation",                     "credits": 3, "is_required": False},
          {"subject": "MGPO", "catalog": "390", "title": "Business and the Political Environment",   "credits": 3, "is_required": False},
          {"subject": "MGPO", "catalog": "420", "title": "Strategic Change and Organization Design", "credits": 3, "is_required": False},
          {"subject": "MGPO", "catalog": "430", "title": "Social Entrepreneurship",                  "credits": 3, "is_required": False},
          {"subject": "MGPO", "catalog": "434", "title": "Topics in Strategic Management 1",         "credits": 3, "is_required": False},
          {"subject": "MGPO", "catalog": "440", "title": "Strategies for Sustainability",            "credits": 3, "is_required": False},
          {"subject": "MGPO", "catalog": "450", "title": "The Origins of Capitalism",               "credits": 3, "is_required": False},
      ...
      {
        "block_key": "stra_major_outside",
        "title": "Outside Discipline Courses",
        "block_type": "group",
        "credits_needed": 9,
        "courses_needed": None,
        "group_name": "9 credits from approved outside disciplines",
        "notes": (
          "9 credits from approved courses outside Management Policy, "
          "including arts, social sciences, or other management areas."
        ),
        "sort_order": 3,
        "courses": [
          {"subject": "ECON", "catalog": "230D1", "title": "Microeconomic Theory",            "credits": 3, "is_required": False},
          {"subject": "ECON", "catalog": "352D1", "title": "International Trade",             "credits": 3, "is_required": False},
          {"subject": "POLI", "catalog": "244",   "title": "International Relations",         "credits": 3, "is_required": False},
          {"subject": "POLI", "catalog": "340",   "title": "Comparative Politics",            "credits": 3, "is_required": False},
          {"subject": "SOCI", "catalog": "210",   "title": "Self and Society",                "credits": 3, "is_required": False},
        ],
      },
    ],
  },

  {
    ...
    "blocks": [
      {
        "block_key": "stra_global_required",
        "title": "Required Global Strategy Courses",
        "block_type": "required",
        "credits_needed": 9,
        "courses_needed": None,
        "group_name": None,
      ...
      {
        "block_key": "stra_global_complementary",
        "title": "Complementary Courses",
        "block_type": "group",
        "credits_needed": 6,
        "courses_needed": None,
        "group_name": "6 credits from Complementary Courses",
        "notes": "Select 2 courses from MGPO or approved outside disciplines.",
        "sort_order": 2,
        "courses": [
          {"subject": "MGPO", "catalog": "341", "title": "Strategies for Developing Countries",      "credits": 3, "is_required": False},
          {"subject": "MGPO", "catalog": "349", "title": "Strategic Innovation",                     "credits": 3, "is_required": False},
          ...
          {"subject": "MGPO", "catalog": "430", "title": "Social Entrepreneurship",                  "credits": 3, "is_required": False},
          {"subject": "MGPO", "catalog": "434", "title": "Topics in Strategic Management 1",         "credits": 3, "is_required": False},
          {"subject": "ORGB", "catalog": "380", "title": "Managing in Multicultural Settings",       "credits": 3, "is_required": False},
        ],
      },
    ],
  },

  {
    ...
    "blocks": [
      {
        "block_key": "stra_social_required",
        "title": "Required Social Business & Enterprise Courses",
        "block_type": "required",
        "credits_needed": 9,
        "courses_needed": None,
        "group_name": None,
        ...
        "courses": [
          {"subject": "MGPO", "catalog": "340", "title": "Competitive Strategy",    "credits": 3, "is_required": True},
          {"subject": "MGPO", "catalog": "430", "title": "Social Entrepreneurship", "credits": 3, "is_required": True},
          {"subject": "MGPO", "catalog": "440", "title": "Strategies for Sustainability", "credits": 3, "is_required": True},
        ],
      },
      {
        "block_key": "stra_social_complementary",
        "title": "Complementary Courses",
        "block_type": "group",
        "credits_needed": 6,
        "courses_needed": None,
        "group_name": "6 credits from Complementary Courses",
        "notes": "Select 2 courses from MGPO or approved courses (max 3 credits at 200 level).",
        "sort_order": 2,
        "courses": [
          {"subject": "MGPO", "catalog": "341", "title": "Strategies for Developing Countries",      "credits": 3, "is_required": False},
          {"subject": "MGPO", "catalog": "390", "title": "Business and the Political Environment",   "credits": 3, "is_required": False},
          {"subject": "MGPO", "catalog": "420", "title": "Strategic Change and Organization Design", "credits": 3, "is_required": False},
          {"subject": "MGPO", "catalog": "431", "title": "Managing Globalization",                   "credits": 3, "is_required": False},
          {"subject": "MGPO", "catalog": "434", "title": "Topics in Strategic Management 1",         "credits": 3, "is_required": False},
          {"subject": "MGPO", "catalog": "449", "title": "Managing Organizational Change",           "credits": 3, "is_required": False},
        ],
      },
    ],
  },
    ...
    "blocks": [
      {
        ...
        "courses": [
          ...
          {"subject": "INSY", "catalog": "336", "title": "Data Preparation and Analysis for Business Analytics", "credits": 3, "is_required": True},
          {"subject": "INSY", "catalog": "341", "title": "Database Management",                                  "credits": 3, "is_required": True},
          {"subject": "INSY", "catalog": "442", "title": "Data Analysis and Visualization",                      "credits": 3, "is_required": True},
        ],
      },
      {
        "block_key": "itm_major_complementary",
        "title": "Complementary IT Courses",
        "block_type": "group",
        "credits_needed": 18,
        "courses_needed": None,
        "group_name": "Complementary INSY/MGSC Courses",
        "notes": "Select from INSY and related courses to complete 30 credits.",
        "sort_order": 2,
        "courses": [
          {"subject": "INSY", "catalog": "416", "title": "Electronic Business",                    "credits": 3, "is_required": False},
          {"subject": "INSY", "catalog": "434", "title": "Topics in Information Systems 1",        "credits": 3, "is_required": False},
          {"subject": "INSY", "catalog": "446", "title": "Data Mining for Business Analytics",     "credits": 3, "is_required": False},
          {"subject": "INSY", "catalog": "448", "title": "Text and Social Media Analytics",        "credits": 3, "is_required": False},
          {"subject": "INSY", "catalog": "463", "title": "Deep Learning for Business Analytics",   "credits": 3, "is_required": False},
          {"subject": "MGSC", "catalog": "372", "title": "Advanced Business Statistics",           "credits": 3, "is_required": False},
          {"subject": "MGSC", "catalog": "401", "title": "Management Science",                     "credits": 3, "is_required": False},
        ],
      },
    ],
  },

  {
    ...
    "blocks": [
      ...
      {
        "block_key": "itm_conc_complementary",
        "title": "Complementary IT Courses",
        "block_type": "group",
        "credits_needed": 6,
        "courses_needed": None,
        "group_name": "6 credits from Complementary INSY/MGSC Courses",
        "notes": "Select 2 courses (6 credits) from the following list.",
        "sort_order": 2,
        "courses": [
          {"subject": "INSY", "catalog": "416", "title": "Electronic Business",                  "credits": 3, "is_required": False},
    ...
    "blocks": [
      {
        ...
        "courses": [
          ...
          {"subject": "ORGB", "catalog": "330", "title": "People Analytics",                 "credits": 3, "is_required": True},
      ...
      },
      {
        ...
        "title": "Complementary ORGB Courses",
        "block_type": "group",
        "credits_needed": 9,
        "courses_needed": None,
        "group_name": "Complementary Organizational Behaviour Courses",
        "notes": "Select from ORGB and INDR courses.",
        "sort_order": 2,
        "courses": [
          {"subject": "ORGB", "catalog": "325", "title": "Negotiations and Conflict Resolution",    "credits": 3, "is_required": False},
          {"subject": "ORGB", "catalog": "380", "title": "Managing in Multicultural Settings",      "credits": 3, "is_required": False},
          ...
          {"subject": "ORGB", "catalog": "425", "title": "Compensation Management",                 "credits": 3, "is_required": False},
          ...
          {"subject": "INDR", "catalog": "347", "title": "Introduction to Labour-Management Relations", "credits": 3, "is_required": False},
          {"subject": "INDR", "catalog": "349", "title": "Comparative Labour Relations",            "credits": 3, "is_required": False},
        ],
      },
      {
        ...
        "courses": [
          ...
          {"subject": "INDR", "catalog": "260", "title": "Labour-Management Relations",              "credits": 3, "is_required": False},
        ],
      },
    ],
  },
    ...
    "blocks": [
      {
        ...
        "sort_order": 1,
        "courses": [
          {"subject": "INDR", "catalog": "347", "title": "Introduction to Labour-Management Relations", "credits": 3, "is_required": True},
          {"subject": "ORGB", "catalog": "321", "title": "Leadership",                                  "credits": 3, "is_required": True},
          {"subject": "ORGB", "catalog": "423", "title": "Human Resources Management",                  "credits": 3, "is_required": True},
        ],
      },
      {
        ...
        "courses": [
          {"subject": "INDR", "catalog": "349", "title": "Comparative Labour Relations",            "credits": 3, "is_required": False},
          {"subject": "INDR", "catalog": "355", "title": "Labour Law",                              "credits": 3, "is_required": False},
          {"subject": "ORGB", "catalog": "325", "title": "Negotiations and Conflict Resolution",    "credits": 3, "is_required": False},
  ...
  # ══════════════════════════════════════════════════════════════════
  {
    ...
    "blocks": [
      ...
      },
      {
        ...
        "credits_needed": 6,
        "courses_needed": None,
        "group_name": "6 credits from Complementary MGSC Courses",
        "notes": "Select 2 courses (6 credits) from the following list.",
        "sort_order": 2,
        "courses": [
          {"subject": "MGSC", "catalog": "416", "title": "Data-Driven Models for Operations Analytics",  "credits": 3, "is_required": False},
    ...
    "blocks": [
      {
        ...
        "courses": [
          {"subject": "MGPO", "catalog": "431", "title": "Managing Globalization",           "credits": 3, "is_required": True},
          {"subject": "ORGB", "catalog": "380", "title": "Managing in Multicultural Settings", "credits": 3, "is_required": True},
          {"subject": "MRKT", "catalog": "483", "title": "International Marketing Management", "credits": 3, "is_required": True},
        ],
      },
      {
        "block_key": "intl_major_complementary",
        "title": "Complementary International Courses",
        "block_type": "group",
        "credits_needed": 21,
        "courses_needed": None,
        "group_name": "Complementary International Management Courses",
        "notes": "Select from MGPO, ORGB, FINE, MRKT, and approved outside-management courses.",
        "sort_order": 2,
        "courses": [
          {"subject": "FINE", "catalog": "482", "title": "International Finance 1",                        "credits": 3, "is_required": False},
          {"subject": "FINE", "catalog": "484", "title": "International Finance 2",                        "credits": 3, "is_required": False},
          ...
          {"subject": "POLI", "catalog": "244", "title": "Introduction to International Relations",        "credits": 3, "is_required": False},
        ],
      },
    ],
  },

  {
    ...
    "blocks": [
      ...
      },
      {
        ...
        "courses_needed": None,
        "group_name": "6 credits from Complementary Courses",
        "notes": "Select 2 courses from FINE, MGPO, or approved courses.",
        "sort_order": 2,
        "courses": [
          {"subject": "FINE", "catalog": "482", "title": "International Finance 1",               "credits": 3, "is_required": False},
          {"subject": "FINE", "catalog": "484", "title": "International Finance 2",               "credits": 3, "is_required": False},
    ...
    "blocks": [
      {
        ...
        "courses": [
          {"subject": "MGPO", "catalog": "440", "title": "Strategies for Sustainability",       "credits": 3, "is_required": True},
          {"subject": "MGPO", "catalog": "430", "title": "Social Entrepreneurship",             "credits": 3, "is_required": True},
          {"subject": "MRKT", "catalog": "351", "title": "Marketing and Society",              "credits": 3, "is_required": True},
          {"subject": "MGPO", "catalog": "341", "title": "Strategies for Developing Countries", "credits": 3, "is_required": True},
        ],
      },
      {
        "block_key": "sust_major_complementary_mgmt",
        "title": "Complementary Management Courses",
        "block_type": "group",
        "credits_needed": 9,
        "courses_needed": None,
        "group_name": "Complementary Management and Sustainability Courses",
        "notes": "Select from approved management sustainability and related courses.",
        "sort_order": 2,
        "courses": [
          {"subject": "MGPO", "catalog": "431", "title": "Managing Globalization",               "credits": 3, "is_required": False},
          {"subject": "ORGB", "catalog": "325", "title": "Negotiations and Conflict Resolution", "credits": 3, "is_required": False},
      ...
      },
      {
        ...
        "title": "Environmental/Outside Courses",
        "block_type": "group",
        "credits_needed": 9,
        "courses_needed": None,
        "group_name": "Environment, Social Sciences, or Interdisciplinary Courses",
        "notes": (
          "Select from ENVR, GEOG, ECON, SOCI, or other approved interdisciplinary "
          "courses. Note: ENVR courses have limited enrolment."
        ),
        "sort_order": 3,
        "courses": [
          {"subject": "ENVR", "catalog": "200", "title": "Society, Environment and Sustainability",  "credits": 3, "is_required": False},
          {"subject": "ENVR", "catalog": "201", "title": "The Global Environment",                  "credits": 3, "is_required": False},
          {"subject": "ENVR", "catalog": "300", "title": "The Evolving Earth",                      "credits": 3, "is_required": False},
          {"subject": "ENVR", "catalog": "430", "title": "Environmental Thought",                   "credits": 3, "is_required": False},
          {"subject": "ENVR", "catalog": "441", "title": "Knowledge, Ethics and Environment",       "credits": 3, "is_required": False},
          {"subject": "GEOG", "catalog": "201", "title": "Human Geography",                         "credits": 3, "is_required": False},
...

  {
    ...
    "blocks": [
      ...
      {
        "block_key": "sust_conc_complementary",
        "title": "Complementary Sustainability Courses",
        "block_type": "group",
        "credits_needed": 6,
        "courses_needed": None,
        "group_name": "6 credits from Complementary Courses",
        "notes": "Select 2 courses from approved sustainability-related courses.",
        "sort_order": 2,
        "courses": [
          {"subject": "MGPO", "catalog": "341", "title": "Strategies for Developing Countries",         "credits": 3, "is_required": False},
          {"subject": "MGPO", "catalog": "431", "title": "Managing Globalization",                      "credits": 3, "is_required": False},
    ...
    "blocks": [
      {
        ...
        "courses_needed": None,
        "group_name": None,
        "notes": "5 required courses (15 credits).",
        "sort_order": 1,
        "courses": [
          {"subject": "MRKT", "catalog": "354", "title": "Marketing Strategy",             "credits": 3, "is_required": True},
          {"subject": "MRKT", "catalog": "452", "title": "Consumer Behaviour",             "credits": 3, "is_required": True},
      ...
      },
      {
        ...
        "credits_needed": 12,
        "courses_needed": None,
        "group_name": "Complementary Retail and Related Courses",
        "notes": "Select from approved retail management and related courses.",
        "sort_order": 2,
        "courses": [
          {"subject": "MRKT", "catalog": "438", "title": "Brand Management",                              "credits": 3, "is_required": False},
          {"subject": "MRKT", "catalog": "440", "title": "Marketing Analytics",                           "credits": 3, "is_required": False},
          ...
          {"subject": "MGSC", "catalog": "401", "title": "Management Science",                            "credits": 3, "is_required": False},
          {"subject": "ORGB", "catalog": "321", "title": "Leadership",                                    "credits": 3, "is_required": False},
          {"subject": "BUSA", "catalog": "450", "title": "Entrepreneurship and New Venture Planning",     "credits": 3, "is_required": False},
        ],
      },
      {
        "block_key": "retl_major_el",
        "title": "Experiential Learning",
        "block_type": "required",
        "credits_needed": 3,
        "courses_needed": None,
        ...
        "sort_order": 3,
        "courses": [
          {"subject": "RETL", "catalog": "435", "title": "Sustainable Retail and Entrepreneurship", "credits": 3, "is_required": True},
        ],
      },
    ],
  },
    ...
    "blocks": [
      {
        ...
        "courses": [
          {"subject": "MRKT", "catalog": "452", "title": "Consumer Behaviour",  "credits": 3, "is_required": True},
          {"subject": "MRKT", "catalog": "459", "title": "Retail Management",   "credits": 3, "is_required": True},
          {"subject": "MRKT", "catalog": "453", "title": "Advertising and Media","credits": 3, "is_required": True},
        ],
      },
      {
        ...
        "notes": "Select 2 courses from approved retail-related courses.",
        "sort_order": 2,
        "courses": [
    ...
    "blocks": [
      {
        ...
        "sort_order": 1,
        "courses": [
          {"subject": "BUSA", "catalog": "450", "title": "Entrepreneurship and New Venture Planning",  "credits": 3, "is_required": True},
          {"subject": "MGPO", "catalog": "430", "title": "Social Entrepreneurship",                    "credits": 3, "is_required": True},
          {"subject": "MGPO", "catalog": "349", "title": "Strategic Innovation",                       "credits": 3, "is_required": True},
        ],
      },
      {
        ...
        "courses_needed": None,
        "group_name": "6 credits from Complementary Courses",
        "notes": "Select 2 courses from approved entrepreneurship-related courses.",
        "sort_order": 2,
        "courses": [
          {"subject": "FINE", "catalog": "342", "title": "Corporate Finance",                    "credits": 3, "is_required": False},
          {"subject": "MRKT", "catalog": "365", "title": "New Products",                         "credits": 3, "is_required": False},
          {"subject": "MRKT", "catalog": "354", "title": "Marketing Strategy",                   "credits": 3, "is_required": False},
          {"subject": "MGPO", "catalog": "340", "title": "Competitive Strategy",                 "credits": 3, "is_required": False},
          {"subject": "ORGB", "catalog": "325", "title": "Negotiations and Conflict Resolution", "credits": 3, "is_required": False},
        ],
      },
    ],
  ...
  # ══════════════════════════════════════════════════════════════════
  {
    ...
    "blocks": [
      {
        "block_key": "ethc_conc_required",
        "title": "Required Ethics Courses",
        "block_type": "required",
        "credits_needed": 9,
        "courses_needed": None,
        "group_name": None,
        ...
        "courses": [
          {"subject": "MGPO", "catalog": "340", "title": "Competitive Strategy",             "credits": 3, "is_required": True},
          {"subject": "ORGB", "catalog": "410", "title": "Ethics in Management",             "credits": 3, "is_required": True},
          {"subject": "MGPO", "catalog": "430", "title": "Social Entrepreneurship",          "credits": 3, "is_required": True},
        ],
      },
      {
        "block_key": "ethc_conc_complementary",
        "title": "Complementary Ethics Courses",
        "block_type": "group",
        "credits_needed": 6,
        "courses_needed": None,
        "group_name": "6 credits from Complementary Courses",
        "notes": "Select 2 courses from approved ethics and social responsibility courses.",
        "sort_order": 2,
        "courses": [
          {"subject": "MGPO", "catalog": "440", "title": "Strategies for Sustainability",       "credits": 3, "is_required": False},
          {"subject": "MRKT", "catalog": "351", "title": "Marketing and Society",              "credits": 3, "is_required": False},
    ...
    "blocks": [
      ...
      },
      {
        ...
        "courses": [
          ...
          {"subject": "FINE", "catalog": "342",  "title": "Corporate Finance",                  "credits": 3, "is_required": False},
          {"subject": "FINE", "catalog": "448",  "title": "Financial Derivatives",              "credits": 3, "is_required": False},
          {"subject": "INSY", "catalog": "336",  "title": "Data Preparation and Analysis",      "credits": 3, "is_required": False},
        ],
      },
    ],
  },
