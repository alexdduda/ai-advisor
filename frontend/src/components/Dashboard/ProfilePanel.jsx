...
import { FaCamera, FaChartBar, FaLightbulb, FaSave, FaUser, FaCog, FaBullseye } from 'react-icons/fa'
import { FaGraduationCap, FaCalendarAlt, FaEnvelope } from 'react-icons/fa'
        ...
        <div className="profile-grid">
          ...
          <div className="profile-section-card">
            <div className="card-header">
              ...
              {!editing && (
                <button className="btn-icon-edit" onClick={openEditor} title="Edit Profile"><FaSave /></button>
              )}
            </div>
              ...
              {!editing ? (
                ...
                <form className="edit-form" onSubmit={handleUpdate}>
                  ...
                  <div className="form-actions-inline">
                    <button type="submit" className="btn btn-primary-sm"><FaSave /> Save Changes</button>
